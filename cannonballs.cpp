...
Cannonballs::Cannonballs(float x, float y, float z) {
...
void Cannonballs::draw(glm::mat4 VP) {
...
void Cannonballs::set_position(float x, float y, float z) {
    this->position = glm::vec3(x, y, z);
}

void Cannonballs::tick() {
